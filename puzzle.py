...
#
#----------------------------------------------------------------------------------
from solver import bfs, state, goal_state, n
#from solver.py import the function bfs, and the variables state, goal_state, and n (see solver.py for documentation)

 
steps = bfs(state,goal_state) #a list with all the steps
